...
<#if doc.result.entities[0].entity_type=="Request">
<#assign targetAttachments=parseJson(doc.result.entities[0].properties.RequestAttachments) />
<#elseif doc.result.entities[0].entity_type=="Incident">
