...
/rest/${instanceConfig.organization}/ems/Person?layout=Upn,Id&filter=${"PhaseId='new' and Email='"+message.args.entity.properties.RequestedForPerson+"'"}&meta=totalCount
</#escape>