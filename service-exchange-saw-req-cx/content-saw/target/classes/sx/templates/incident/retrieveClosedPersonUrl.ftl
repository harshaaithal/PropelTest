...
/rest/${instanceConfig.organization}/ems/Person?layout=Name,Id&filter=${"((IsSystemIntegration!='true' and IsSystem!='true') and Email='"+message.args.entity.properties.UAClosedByPerson+"')"}&meta=totalCount
</#escape>