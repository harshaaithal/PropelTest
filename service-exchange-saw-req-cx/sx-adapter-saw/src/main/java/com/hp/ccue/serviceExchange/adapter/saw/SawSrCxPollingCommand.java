...
@Component
public class SawSrCxPollingCommand extends CxPollingByAliasCommand {

    private static final String ID = "Id";
    private static final String PROPERTIES = "properties";
    private static final String ENTITIES = "entities";
    public static final String OPERATION_GET_CHANGES = "getChangedRequestsCX";

    @Value("${adapter.saw.change.listener.delayBeforeNextRun}")
    private int pollInterval;

    @Autowired
    public SawSrCxPollingCommand(SawOperationExecutor operationExecutor,
                               SawCaseExchangeRuleStore sawCxRuleStore,
                               SawEventFilterEvaluator eventFilterEvaluator) {
        super(SawConstants.SAW_TYPE, SawConstants.ENTITY_REQUEST, SXConstants.SawInstancesCfg.CFG_NAME, OPERATION_GET_CHANGES,
